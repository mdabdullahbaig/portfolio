      ...
      <div className="header">
        ...
        <div className="interest-box">
          <p>
            ...
            can implement a real situation with the help of code. I spend large
            amount of my free time exploring the{" "}
          ...
          <p>
            ...
            <span className="spanClass">Material UI</span> and{" "}
            <span className="spanClass">ReactIcon</span> for Icon. There is a
            contact section where you can give me feedback and ask anything. For
            taking data from form in contact section, I used{" "}
            <span className="spanClass"> React Hook Form</span> and for frontent
            validation <span className="spanClass">yup</span> library. I made
            API with <span className="spanClass">Node.js</span> ,{" "}
          ...
          <p>I built this website and that was amazing experience for me.</p>
        </div>
        <h2 style={{ textAlign: "right", padding: "45px", color: "#fa0355" }}>
          Thank You!
        </h2>
      </div>
    </Wraper>
